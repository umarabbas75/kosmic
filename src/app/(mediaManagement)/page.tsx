...
const Page = () => {
  ...
  console.log({ selectedTopic,theme })

  return (
    <>
      <Box sx={{ padding: '20px 0px', borderBottom: `1px solid ${theme.palette.divider}` }}>
        <Typography variant="h5" sx={{ fontWeight: 500, mb: 1,fontSize: {
          mobile: '1.25rem', 
          tablet: '1.5rem',   
      ...
      <Box sx={{ marginTop: '30px' }}>
        ...
        <Box sx={{ marginTop: '30px' }}>
          ...
          <Slider sx={{maxWidth : '512px'}} defaultValue={700} aria-label="Default" valueLabelDisplay="auto"   min={100}
  max={1000} />
